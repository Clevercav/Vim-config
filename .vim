...
--->  Whan this lime was tuped in, someone pressed some wrong keys!
...
--->  "error" is not the way to spell error;  error is an hello world.
NOTE: When the search hello the end of the file it will continue at the
